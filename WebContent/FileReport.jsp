        ...
        <div id="wrapper">
            ...
            <section class="contact-block">
            	<div class="container">
            		<div class="row">
            			<div class="col-md-12">
            				<h1 class="main-page-header">File a Report</h1>
            				<h3 class="main-sub-header">Bring your problems to the Admin</h3>
            			</div>
            		</div><!-- row -->
            		<div class="row">
            			<div class="col-md-12">
            				<form id="contact-form" method="post" action="Report">
                                <div class="clearfix">
            						<label>Report Subject<span>*</span></label>
            						<input name="subj" type="text" required>
                                    <label>Description/Issue<span>*</span></label>
                                    <textarea name="detl" rows="5" required></textarea>
