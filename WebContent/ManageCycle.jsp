        ...
        <div id="wrapper">
            ...
            <section class="contact-block">
            	<div class="container">
            		<div class="row">
            			<div class="col-md-12">
            				<h1 class="main-page-header">Manage Your Cycle</h1>
            				<h3 class="main-sub-header">After all its Yours</h3>
            			</div>
            		</div><!-- row -->
            		<div class="row">
            			<div class="col-md-12">
							...
							ResultSet rs=stmt.executeQuery("SELECT * FROM cycle_data WHERE username = '"+name+"'");
							%>
