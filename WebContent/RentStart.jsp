            	...
            	<div class="container">
            		...
            		<div class="row">
            			<div class="col-md-12">
							...
							ResultSet rs=stmt.executeQuery("SELECT * FROM full_user WHERE username = '"+session.getAttribute("rentfrom")+"'");
							%>
							<TABLE align="center" cellpadding="15" border="10" style="background-color: #ffffcc;">
							<%
							while (rs.next()) {
							%>
							<TR>
